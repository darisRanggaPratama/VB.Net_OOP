...
Public Class Form_Lap_Jual_Bulan
	Private Sub btnView_Click(sender As Object, e As EventArgs) Handles btnView.Click
			...
			Dim lapBarang As new Lap_Jual_Bulan
...
.Password = ""
			...
			Next
			crystalBulan.SelectionFormula = "Month({tbl_jual.tgl_jual})="& Val(comBulan.Text) & " and Year({tbl_jual.tgl_jual})="& Val(comTahun.Text)
			crystalBulan.ReportSource = cryRpt
			crystalBulan.Refresh()
			crystalBulan.RefreshReport()
	...
	Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
		crystalBulan.PrintReport()
	End Sub

	Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
		crystalBulan.ExportReport()
	End Sub
End Class